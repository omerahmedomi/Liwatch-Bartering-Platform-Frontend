...
export default function ListingsFiltersPanel({
  ...
  return (
    <div className="bg-white dark:bg-slate-900 text-sm  p-4 md:p-6 shadow-sm border-b  border-slate-100 dark:border-slate-800 mb-8 ">
      <div className="flex flex-col md:flex-row gap-4">
        <div className="relative grow">
          ...
          <input
            ...
            className="w-full bg-slate-50 dark:bg-slate-950 pl-12 pr-4 py-4 rounded-2xl border-none text-slate-900 dark:text-slate-100 placeholder:text-slate-400 font-medium focus:ring-2 focus:ring-indigo-600 outline-none transition-all"
          />
        </div>

        <div className="flex overflow-x-auto hide-scrollbar gap-2 shrink-0 items-center">
          <div className="flex bg-slate-50 dark:bg-slate-950 p-1 rounded-2xl shrink-0">
            <button
      ...
      <div className="flex overflow-x-auto hide-scrollbar gap-2 mt-4 pt-4 border-t border-slate-100 dark:border-slate-800 items-center">
        <SlidersHorizontal
          size={16}
