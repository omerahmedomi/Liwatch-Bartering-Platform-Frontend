  ...
  return (
    ...
    <section className="py-24 bg-slate-50 relative overflow-hidden" id="howitworks">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <Link href={`/auth?mode=signup`} className="bg-indigo-600 text-white px-10 py-4 rounded-full font-bold hover:bg-indigo-700 transition-all transform hover:-translate-y-1 shadow-lg shadow-indigo-500/20">
